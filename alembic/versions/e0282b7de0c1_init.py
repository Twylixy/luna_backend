...
Revision ID: e0282b7de0c1
Revises: 
Create Date: 2023-02-12 20:08:45.531025
...
def upgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['settings_id'], ['guild_settings.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id'),
